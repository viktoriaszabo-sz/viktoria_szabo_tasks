      ...
      <div class="container-fluid">
        ...
        >
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link" href="create.php"><b>Create</b></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="read.php"><b>Read</b></a>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link" href="updatesingle.php"><b>Update</b></a>
            </li>
            <li class="nav-item dropdown">
